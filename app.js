let cuadro_btn = document.querySelectorAll(".square");
...
function comprobar() {
  ...
  if (
    (cuadro_btn[0].innerHTML == "X" &&
      cuadro_btn[1].innerHTML == "X" &&
      cuadro_btn[2].innerHTML == "X") ||
    (cuadro_btn[3].innerHTML == "X" &&
      cuadro_btn[4].innerHTML == "X" &&
      cuadro_btn[5].innerHTML == "X") ||
    (cuadro_btn[6].innerHTML == "X" &&
      cuadro_btn[7].innerHTML == "X" &&
      cuadro_btn[8].innerHTML == "X") ||
    (cuadro_btn[0].innerHTML == "X" &&
      cuadro_btn[3].innerHTML == "X" &&
      cuadro_btn[6].innerHTML == "X") ||
    (cuadro_btn[1].innerHTML == "X" &&
    ...
    (cuadro_btn[0].innerHTML == "O" &&
      cuadro_btn[1].innerHTML == "O" &&
      cuadro_btn[2].innerHTML == "O") ||
    (cuadro_btn[3].innerHTML == "O" &&
      cuadro_btn[4].innerHTML == "O" &&
      cuadro_btn[5].innerHTML == "O") ||
    (cuadro_btn[6].innerHTML == "O" &&
      cuadro_btn[7].innerHTML == "O" &&
      cuadro_btn[8].innerHTML == "O") ||
    (cuadro_btn[0].innerHTML == "O" &&
      cuadro_btn[3].innerHTML == "O" &&
      cuadro_btn[6].innerHTML == "O") ||
    (cuadro_btn[1].innerHTML == "O" &&
...
/**
 * funcion deshabilitar secciones
 * @param {*} y
 */
...
function nEmpieza() {
  ...
  // 
  cuadro_btn.forEach((boton) => {
    boton.classList.remove('diagonalCross');
  })
...
function checkForEffect() {
  if (
    cuadro_btn[0].innerHTML == "X" &&
    cuadro_btn[1].innerHTML == "X" &&
    cuadro_btn[2].innerHTML == "X"
  ) {
    cuadro_btn[0].classList.add("diagonalCross");
    cuadro_btn[1].classList.add("diagonalCross");
    cuadro_btn[2].classList.add("diagonalCross");
  }
  if (
    cuadro_btn[3].innerHTML == "X" &&
    cuadro_btn[4].innerHTML == "X" &&
    ...
    cuadro_btn[3].classList.add("diagonalCross");
    cuadro_btn[4].classList.add("diagonalCross");
    cuadro_btn[5].classList.add("diagonalCross");
  }
  if (
    cuadro_btn[6].innerHTML == "X" &&
    cuadro_btn[7].innerHTML == "X" &&
    ...
    cuadro_btn[6].classList.add("diagonalCross");
    cuadro_btn[7].classList.add("diagonalCross");
    cuadro_btn[8].classList.add("diagonalCross");
  }
  if (
    cuadro_btn[0].innerHTML == "X" &&
    cuadro_btn[3].innerHTML == "X" &&
